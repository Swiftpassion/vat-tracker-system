...
# ==========================================
    ...
    if not records:
        ...
        div[data-testid="stForm"] { border: none !important; padding: 0 !important; margin-top: -15px; }
        </style>
        """, unsafe_allow_html=True)
        ...
        # 1. แถวควบคุมด้านบน (โซนซ้าย: อยู่นอก Form เพื่อให้เปลี่ยนหน้าได้ทันที)
        ...
        # 2. แถวควบคุมด้านล่าง (โซนขวา: อยู่ใน Form เพื่อจัดการตาราง)
